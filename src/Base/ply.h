...
struct PlyMeshVertex {
    PlyMeshVertex() : x(0) , y(0) , z(0) , point3D_idx(-1) {}
    PlyMeshVertex(const float x , const float y , const float z)
        : x(x) , y(y) , z(z) {}
    PlyMeshVertex(const float x , const float y , const float z , const size_t pid)
        : x(x) , y(y) , z(z) , point3D_idx(pid) {}

    float x = 0.0f;
    float y = 0.0f;
    float z = 0.0f;
    point3D_t point3D_idx = -1;
};
